                    ...
                    <section class="hbox stretch" >
                        <section>
                            <section class="vbox">
                                ...
                                <div id="showmy" style="margin-bottom:30px;">
                                <div id="minchat">
                                ...
                                <footer class="footer bg-light lt b-t b-light" style=" position: fixed;
                                    ...
                                    <input type="file" id='image' name="images"  accept="image/png, image/gif, image/jpeg, image/jpg" style="position:absolute;z-index:1;" > <div style="text-align: center; position:relative;height:1px" id="type"></div> <p style="text-align: right; position:relative;margin-right:5px "  id='seen' ></p>
                                        <div class="input-group">
                                         <input  autocomplete="off"  id="sms" name="sms" type="text" class="form-control input-sm rounded" placeholder="Say something" autofocus> <span class="input-group-btn"> <button name="submit" id='text' type="submit" class="btn btn-sm btn-danger font-bold btn-rounded" type="button">Send</button> </span>                                            </div>
                                        </form>
                                </footer>
                            </section>
                        </section>
...
var myid=$('#myid').val();
var sms=$('#sms').val();
var lod='  <article class="chat-item right"> <a href="#" class="pull-right thumb-sm avatar"> <div class="loader2"></div></a><section class="chat-body"><div class="panel bg-light dk text-sm m-b-none"><div class="panel-body"> <span class="arrow right"></span><p class="m-b-none">'+sms+' </p></div></div> <small class="text-muted">now</small> </section></article>';
if(sms==""){
...
$(document).on('submit','form#from',function(event){
  ...
  if(image==""){
   ...
   var loadimg='<article class="chat-item right"> <a href="#" class="pull-right thumb-sm avatar"><div class="loader2"></div></a><section class="chat-body"><div class="panel bg-light dk text-sm m-b-none"><div class="panel-heading b-b b-light"> <a href="#" data-toggle="class" class="pull-right m-l-sm m-t-xs"><i class="i i-pause i-lg text-muted text"></i><i class="i i-play i-lg text-muted text-active"></i></a> <span class="pull-left m-r-sm m-t-xs"><i class="i i-pictures i-lg text-muted"></i></span><div class="clear"><div class="progress progress-xs progress-striped active m-b-none m-t-sm"><div class="progress-bar bg-info dk" data-toggle="tooltip" data-original-title="40%" style="width: 0%"></div></div> <span>'+image+'</span> </div></div></div> <small class="text-muted">now</small> </section></article>'; 
$('.img').html(loadimg)
window.scrollTo(0, document.body.scrollHeight);
